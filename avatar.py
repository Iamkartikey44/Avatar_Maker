...
st.sidebar.header("Customize your avatar👨‍⚕️")
hide_style ="""
<style>
...
st.sidebar.markdown('# Head top',unsafe_allow_html=True)
option_top_type = st.sidebar.selectbox('Head top :tophat:',
                                        list_top_type,
                                        index = index_top_type)
option_hair_color = st.sidebar.selectbox('Hair color 👨‍🎤 👩‍🎤 👩‍🦰',
                                         list_hair_color,
                                         index = index_hair_color)
option_hat_color = st.sidebar.selectbox('Hat color :billed_cap:',
                                         list_hat_color,
                                         index = index_hat_color)

st.sidebar.markdown('# Face',unsafe_allow_html=True)
...
option_eye_type = st.sidebar.selectbox('Eye type :eyes:',
                                        list_eye_type,
                                        index = index_eye_type)
option_eyebrow_type = st.sidebar.selectbox('Eyebrow type :face_with_raised_eyebrow:',
                                            list_eyebrow_type,
                                            index = index_eyebrow_type)
st.sidebar.markdown('# Accessories 👓',unsafe_allow_html=True)
option_accessories_type = st.sidebar.selectbox('Accessories type',
                                                list_accessories_type,
                                                index = index_accessories_type)
st.sidebar.markdown('# Clothe ',unsafe_allow_html=True)

option_clothe_type = st.sidebar.selectbox('Clothe type :necktie::coat:',
                                           list_clothe_type,
                                           index = index_clothe_type)
option_clothe_color = st.sidebar.selectbox('Clothe Color 👕:womans_clothes:',
                                            list_clothe_color,
